...
namespace GeoAlgorithm.Net.Curves
{
    /// <summary>
    ...
    internal class CubicBezier
    {
        ...
        /// <param name="epsilon">Precision in calculating the result. Long animations need more percise calculations to avoid ugly jumps.</param>
